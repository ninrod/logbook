...
** fix virtual console
   ...
   #+END_SRC
** fix lang
1. uncomment pt_BR.UTF-8 in /etc/locale.gen
2. run =locale-gen=
3. certify that pt_BR is installed: run =localectl list-locales=
4. now install pt_BR: localectl set-locale LANG=pt_BR.UTF-8
5. reboot and login
** fix layout
